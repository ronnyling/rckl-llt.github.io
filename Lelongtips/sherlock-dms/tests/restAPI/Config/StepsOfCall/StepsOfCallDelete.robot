...
*** Test Cases ***
1 - Able to Delete an SOC with Salesman as Delivery Rep and Transaction Control as Request
    [Documentation]    Able to Delete an SOC with Salesman as Delivery Rep and Transaction Control as Request
