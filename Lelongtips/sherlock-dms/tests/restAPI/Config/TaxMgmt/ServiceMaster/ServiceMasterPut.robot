...
Library           ${EXECDIR}${/}resources/restAPI/Config/TaxMgmt/ServiceMaster/ServiceMasterPut.py
...
*** Test Cases ***
1 - Able to update Service master
    [Documentation]    Able to update created service master and return status code 200
    [Tags]     hqadm    9.0
    ...
    Then expected return status code 201
    When user updates service master using random data
