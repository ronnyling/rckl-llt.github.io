...
*** Test Cases ***
1 - Able to POST Non Prime Debit Note Non Prod
    [Documentation]    Able to post non prime debit note non prod
    [Tags]    distadm    9.2
    [Setup]  run keywords
...
2 - Able to POST Prime Debit Note Non Prod
    [Documentation]    Able to post prime debit note non prod
    [Tags]    distadm    9.2
    [Setup]  run keywords
