...
Library          ${EXECDIR}${/}resources/restAPI/CustTrx/Picklist/PickListDelete.py

*** Test Cases ***
1 - Able to delete prime picklist and return 200
    [Documentation]    Able to delete Picklist
    [Tags]    distadm
