...
Library           ${EXECDIR}${/}resources/restAPI/MasterDataMgmt/Product/ProductUomPut.py
Library           ${EXECDIR}${/}resources/restAPI/MasterDataMgmt/Product/ProductUomDelete.py
...
*** Test Cases ***
1 - Able to DELETE created product uom
    [Documentation]    Able to delete created product uom
    [Tags]    hqadm
    ...
    When user deletes created product uom
    Then expected return status code 200
