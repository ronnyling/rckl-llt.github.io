...
Library           ${EXECDIR}${/}resources/restAPI/MasterDataMgmt/Promo/PromoGet.py
Library           ${EXECDIR}${/}resources/restAPI/MasterDataMgmt/Promo/PromoDelete.py

*** Test Cases ***
1 - Able to GET Promotion with POSM Assignment schema and get 200
    [Documentation]    To retrieve promotion with POSM assignment via API
    [Tags]     hqadm    9.1.1    NRSZUANQ-41963
    ...
    When user retrieves promotion by id
