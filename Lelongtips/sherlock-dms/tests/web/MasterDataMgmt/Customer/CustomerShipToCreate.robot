...
*** Test Cases ***
1 - Able to create new ship to address
    [Documentation]    Able to create new ship to address
    [Tags]     distadm
    ...
    When user creates a new ship to address
    Then ship to address created successfully with message 'Record created'