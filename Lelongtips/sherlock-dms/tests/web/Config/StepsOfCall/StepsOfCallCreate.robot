...
*** Test Cases ***
1 - Able to Create SOC with Delivery Rep as Salesperson with given data
    [Documentation]    Able to Create SOC with Delivery Rep as Salesperson with given data
    [Tags]     sysimp  9.0
    ${SOCDateDetails}=    create dictionary
    ...     StartDate=2040-09-29
    ...     EndDate=2040-09-30
    set test variable  &{SOCDateDetails}  #if dates are not given fixed data then it may fail
