...
*** Test Cases ***
1 - Able to Edit Holiday Calender with given data
    [Documentation]    Able to edit Holiday calender by using given data
    ...
    Then user edits created holiday calendar
    And holiday calendar updated successfully with message 'Record updated successfully'

2 - Able to Edit Holiday Calender with random data
    [Documentation]    Able to edit Holiday calender by using random data
    [Tags]     hqadm  9.1   TC_01   
    ${HCDetails}=    create dictionary
    ...    type=random
    ...    description=random
