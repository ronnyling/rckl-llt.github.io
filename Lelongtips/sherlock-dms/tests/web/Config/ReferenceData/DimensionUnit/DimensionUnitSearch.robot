...
*** Test Cases ***
1-Able to search Dimension Unit using search method
    [Documentation]    To test searching for Dimension Unit using search function
    [Tags]    sysimp    9.2
    ...
    When user searches created dimension unit
