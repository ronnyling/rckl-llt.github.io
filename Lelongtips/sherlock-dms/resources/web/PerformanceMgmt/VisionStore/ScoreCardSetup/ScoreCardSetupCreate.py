""" Python file related to score card setup UI """
...
from resources.web.PerformanceMgmt.visionstore import ScoreCardSetupCreate
from setup.hanaDB import HanaDB
from resources.Common import Common


class ScoreCardSetupCreate(PageObject):
    """ Functions related to score card setup add page """
    PAGE_TITLE = "Performance Management / Gamification / score cards"
    PAGE_URL = "/gamification/score-card-setup"
    scorecard_SETUP_DETAILS = "${score cardSetupDetails}"
    MENU_NAV = "Performance Management | Gamification | score cards"
    scorecard_CODE = "score card Code"
    scorecard_DESC = "score card Description"
    START_DATE = "Start Date"
    END_DATE = "End Date"
    AVAILABLE_REWARD = "Available Reward"
    scorecard_SETUP_CREATED = "score card Setup created"
    TO_POINT = "To (Point)"
    ...
    def validate_user_scope_for_score_card_setup(self, user_role):
        """ Functions to validate user scope for score card setup """
