...
from resources.web.VanInventory.VanStockCount import VanStockCountListing
...
class VanStockCountListing(PageObject):
    PAGE_TITLE = "Van Inventory / Van Stock Count"
    ...
    def user_provides_van_replenishment_header_details(self):
        ...
        VanStockCountListing.VanStockCountListing().click_add_van_stock_count_button()
