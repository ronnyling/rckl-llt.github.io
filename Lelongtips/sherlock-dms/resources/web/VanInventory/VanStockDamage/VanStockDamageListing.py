...
from resources.web.VanInventory.VanStockDamage import VanStockDamageListing
from resources.web import COMMON_KEY, BUTTON, TEXTFIELD, RADIOBTN, DRPSINGLE
from robot.libraries.BuiltIn import BuiltIn
from robot.api.deco import keyword


class VanStockDamageListing(PageObject):
    PAGE_TITLE = "Van Inventory / Van Stock Damage"
    PAGE_URL = "inventory/van-stock-count/NEW"
    REP_DETAILS = "${CountDetails}"
    ...
    def user_provides_van_replenishment_header_details(self):
        ...
        VanStockDamageListing.VanStockDamageListing().click_add_van_stock_damage_button()
