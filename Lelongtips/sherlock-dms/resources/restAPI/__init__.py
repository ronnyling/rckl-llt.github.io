...
PROTOCOL = 'https://'
LLT_URL = 'www.lelongtips.com.my/search?keyword=&property_type%5B%5D=1&property_type%5B%5D=4&property_type%5B%5D=5&property_type%5B%5D=3&state=kl_sel&min_price=150000&max_price=1000000&min_size=&max_size=&sort=price-asc&listing_status=upcoming&page=' #&page=[1-300]'
