...
class DebitNoteNonProductPut(object):
    ...
    @keyword('user updates debit note non product using ${data} data')
    def user_updates_debit_note_non_product(self, data):
        ...
        dn_payload = DebitNoteNonProductPost.DebitNoteNonProductPost().dn_payload("SAVE")
